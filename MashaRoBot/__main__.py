...
PM_START_TEXT = """Hello, My name is ༒ Anamika ༒

Hey , I am a Group Manager,
Made specially for Managing Groups.

This Pro bot was made by [ℙℝ𝕀ℕℂ𝔼](https://t.me/CREZY_KlNG)
Click /help or use button below to find out more about how to use me to my full potential."""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD ༒ Anamika ༒ TO YOUR GROUP ➕️", url="t.me/AnamikaRoobot?startgroup=true"),
    ],
    [
   ...
   [
        InlineKeyboardButton(
            text="🎵 MUSIC GROUP 🎧", url="http://t.me/TomAndJerry18")
   ],
   [
        InlineKeyboardButton(
            text="✨MY BF✨", url="http://t.me/sahil_prajapat"),
        InlineKeyboardButton(
            text="⚜️CHANNEL⚜️", url="https://t.me/Anamika_Updates"),
    ],
    [  
        InlineKeyboardButton(text="👥SUPPORT GROUP👥", url="https://t.me/TomAndJerry18"),
    ], 
    
]

HELP_STRINGS = """
༒  ༒ WITH NEAnamika_Updates FEATURES
...
DONATE_STRING ="""CONTACT ME ON @CREZY_KlNG"""
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm **, a Anamika owerful group management bot built to help you manage your group easily.
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1542665724 and DONATION_LINK:
            update.effective_message.reply_text(
